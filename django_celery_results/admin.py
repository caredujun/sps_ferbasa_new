...
class TaskResultAdmin(admin.ModelAdmin):
    ...
    list_display = ('task_id', 'periodic_task_name', 'task_name_real', 'duration_task', 'date_done', 'status_real', 'worker')
    list_filter = ('status', 'date_done', 'periodic_task_name', 'task_name',
                   'worker')
    readonly_fields = ('date_created', 'date_done', 'result', 'meta', 'status_real', 'duration_task', 'task_name_real')
